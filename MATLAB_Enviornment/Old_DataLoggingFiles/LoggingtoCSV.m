...
%Matrix = textscan(filname,formatSpec,N)
...
for i=1:Length
    ...
    %set(plotGraph,'XData',Time,'YData',Torque1);
    %axis([0 Time min max]);
    %F = [Time; Torque1];    %Create 2x1 array of current timestamp and read value
    %fprintf(fileID,'%4.4f,    %4.4f\r\n',F);   %Save current into the log file
