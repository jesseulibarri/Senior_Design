...
fprintf(fileID,'%s,%s,%s,%s,%s,%s,%s\r\n','Time(s)','Input_Data1','Input_Data2','Input_Data3','Input_Data4','Input_Data5','Input_Data6');

%Other User Defined Properties
plotTitle = 'Input Data vs Time';   %Plot title
xLabel = 'Elapsed Time(s)';         %X-axis label
yLabel = 'Read Data(float)';        %Y-axis label
...
disp('Log/Graph Script Terminated... Thank you for choosing EriLog for your scripting needs!');