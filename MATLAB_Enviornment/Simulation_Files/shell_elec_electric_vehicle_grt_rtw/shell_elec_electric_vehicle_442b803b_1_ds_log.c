...
int32_T shell_elec_electric_vehicle_442b803b_1_ds_log(const NeDynamicSystem *t0,
  const NeDynamicSystemInput *t87, NeDsMethodOutput *t88)
{
  PmRealVector out;
  ...
  out.mX[41] = X_idx_1;
  out.mX[42] = X_idx_0;
  out.mX[43] = Battery_Electrical_model_for_Np_parallel_connected_cells_Ploss;
  out.mX[44] = Battery_Electrical_model_for_Np_parallel_connected_cells_Ploss *
    50.0;
  out.mX[45] = Battery_Controlled_Voltage_Source_p_v * 0.020408163265306121;
  out.mX[46] = Battery_Controlled_Voltage_Source_p_v;
  out.mX[47] = X_idx_0;
  out.mX[48] = (X_idx_0 * -0.00050954 + X_idx_30 * 0.05 + X_idx_31 * 0.05 +
                U_idx_0 * 0.00050954) * 1000.0;
  out.mX[49] = X_idx_0;
  out.mX[50] = 0.0;
  out.mX[51] = X_idx_0;
  out.mX[52] = Battery_Electrical_model_for_Np_parallel_connected_cells_Ploss *
    50.0;
  out.mX[53] = Battery_Electrical_model_for_Np_parallel_connected_cells_Ploss *
    50.0;
  out.mX[54] = -(-X_idx_0) / -1.0;
  out.mX[55] = X_idx_0;
  out.mX[56] = 0.0;
  out.mX[57] = 0.0;
  out.mX[58] = X_idx_0;
  out.mX[59] = X_idx_0;
  out.mX[60] = Battery_Electrical_model_for_Np_parallel_connected_cells_Ploss *
    50.0;
  out.mX[61] = X_idx_0;
  out.mX[62] = 0.0;
  out.mX[63] = 0.0;
  out.mX[64] = Battery_Controlled_Voltage_Source_p_v * 0.020408163265306121;
  out.mX[65] = 0.0;
  out.mX[66] = Battery_Controlled_Voltage_Source_p_v;
  out.mX[67] = X_idx_25;
  out.mX[68] = Battery_Controlled_Voltage_Source_p_v * 0.020408163265306121;
  out.mX[69] = U_idx_0;
  out.mX[70] = X_idx_0;
  out.mX[71] = t42 * 1000.0;
  out.mX[72] = t42 * 1962.5544608862897;
  out.mX[73] = 0.0;
  out.mX[74] = X_idx_34;
  out.mX[75] = X_idx_35;
  out.mX[76] = X_idx_34;
  out.mX[77] = X_idx_3;
  out.mX[78] = X_idx_32;
  out.mX[79] = X_idx_33 * 0.1;
  out.mX[80] = X_idx_36;
  out.mX[81] = X_idx_37 * 0.1;
  out.mX[82] = X_idx_38;
  out.mX[83] = -X_idx_38;
  out.mX[84] = X_idx_39;
  out.mX[85] = X_idx_40;
  ...
  out.mX[96] = X_idx_47;
  out.mX[97] = X_idx_36;
  out.mX[98] = X_idx_37 * 0.1;
  out.mX[99] = 0.0;
  out.mX[100] = X_idx_47;
  out.mX[101] = X_idx_34;
  out.mX[102] = X_idx_36;
  out.mX[103] = X_idx_37 * 0.1;
  out.mX[104] = 0.0;
  out.mX[105] = X_idx_47;
  out.mX[106] = X_idx_38;
  out.mX[107] = 0.0;
  ...
  out.mX[109] = X_idx_47;
  out.mX[110] = X_idx_48;
  out.mX[111] = X_idx_4 * 0.001;
  out.mX[112] = X_idx_5;
  out.mX[113] = X_idx_3 * -1000.0;
  out.mX[114] = X_idx_34;
  out.mX[115] = X_idx_41;
  out.mX[116] = X_idx_37 * 0.1;
  out.mX[117] = X_idx_49;
  out.mX[118] = X_idx_50;
  out.mX[119] = X_idx_51;
  out.mX[120] = X_idx_52;
  out.mX[121] = X_idx_5 * 0.0078539816339744835 + 0.001;
  out.mX[122] = X_idx_53;
  out.mX[123] = X_idx_54 * 0.1;
  out.mX[124] = X_idx_32;
  out.mX[125] = X_idx_33 * 0.1;
  out.mX[126] = f_efOut_idx_0;
  out.mX[127] = X_idx_53;
  out.mX[128] = X_idx_54 * 0.1;
  out.mX[129] = X_idx_32;
  out.mX[130] = X_idx_33 * 0.1;
  out.mX[131] = f_efOut_idx_0;
  out.mX[132] = X_idx_55;
  out.mX[133] = X_idx_57;
  out.mX[134] = X_idx_59;
  out.mX[135] = -X_idx_38 + X_idx_60;
  out.mX[136] = 0.0;
  out.mX[137] = X_idx_6;
  out.mX[138] = X_idx_56;
  out.mX[139] = X_idx_58;
  out.mX[140] = X_idx_61;
  out.mX[141] = -X_idx_41 + X_idx_62;
  out.mX[142] = X_idx_7 * 0.1;
  out.mX[143] = (-X_idx_7 + X_idx_54) * 0.1;
  out.mX[144] = (-X_idx_7 + X_idx_33) * 0.1;
  out.mX[145] = X_idx_63;
  out.mX[146] = X_idx_64;
  out.mX[147] = X_idx_65;
  out.mX[148] = X_idx_66;
  ...
  out.mX[150] = X_idx_68;
  out.mX[151] = X_idx_69;
  out.mX[152] = X_idx_70 * 0.1;
  out.mX[153] = X_idx_71;
  out.mX[154] = X_idx_72 * 0.1;
  out.mX[155] = b_efOut_idx_0;
  out.mX[156] = X_idx_69;
  out.mX[157] = X_idx_70 * 0.1;
  out.mX[158] = X_idx_71;
  out.mX[159] = X_idx_72 * 0.1;
  out.mX[160] = b_efOut_idx_0;
  out.mX[161] = X_idx_73;
  out.mX[162] = X_idx_75;
  out.mX[163] = X_idx_77;
  out.mX[164] = X_idx_78;
  ...
  out.mX[169] = X_idx_79;
  out.mX[170] = -0.2;
  out.mX[171] = X_idx_9 * 0.1;
  out.mX[172] = (-X_idx_9 + X_idx_70) * 0.1;
  out.mX[173] = (-X_idx_9 + X_idx_72) * 0.1;
  out.mX[174] = X_idx_80;
  out.mX[175] = X_idx_81;
  out.mX[176] = X_idx_82;
  out.mX[177] = X_idx_83;
  out.mX[178] = X_idx_84;
  out.mX[179] = X_idx_85;
  out.mX[180] = f_efOut_idx_0;
  out.mX[181] = f_efOut_idx_0;
  out.mX[182] = b_efOut_idx_0;
  out.mX[183] = b_efOut_idx_0;
  out.mX[184] = X_idx_71;
  out.mX[185] = X_idx_72 * 0.1;
  out.mX[186] = X_idx_86;
  out.mX[187] = X_idx_87 * 0.1;
  out.mX[188] = -X_idx_78;
  out.mX[189] = X_idx_88;
  out.mX[190] = X_idx_89;
  out.mX[191] = X_idx_90;
  ...
  out.mX[202] = U_idx_0;
  out.mX[203] = t51;
  out.mX[204] = X_idx_22 * 1000.0;
  out.mX[205] = X_idx_22 * 1000.0;
  out.mX[206] = -(U_idx_0 - t51) / -1.0;
  out.mX[207] = X_idx_69;
  out.mX[208] = X_idx_70 * 0.1;
  out.mX[209] = X_idx_53;
  out.mX[210] = X_idx_54 * 0.1;
  out.mX[211] = t51;
  out.mX[212] = X_idx_69;
  out.mX[213] = X_idx_70 * 0.1;
  out.mX[214] = X_idx_53;
  out.mX[215] = X_idx_54 * 0.1;
  out.mX[216] = t51;
  out.mX[217] = X_idx_96;
  out.mX[218] = X_idx_98;
  out.mX[219] = -X_idx_77;
  ...
  out.mX[225] = -X_idx_79;
  out.mX[226] = -X_idx_61;
  out.mX[227] = X_idx_11 * 0.1;
  out.mX[228] = (-X_idx_11 + X_idx_70) * 0.1;
  out.mX[229] = (-X_idx_11 + X_idx_54) * 0.1;
  out.mX[230] = X_idx_100;
  out.mX[231] = X_idx_101;
  out.mX[232] = X_idx_102;
  out.mX[233] = X_idx_103;
  out.mX[234] = X_idx_104;
  out.mX[235] = X_idx_105;
  out.mX[236] = U_idx_0;
  out.mX[237] = 0.0;
  out.mX[238] = 0.0;
  out.mX[239] = U_idx_0;
  out.mX[240] = U_idx_0;
  out.mX[241] = X_idx_69;
  out.mX[242] = X_idx_70 * 0.1;
  out.mX[243] = X_idx_69;
  out.mX[244] = X_idx_70 * 0.1;
  out.mX[245] = X_idx_79;
  out.mX[246] = X_idx_77 * 1000.0;
  out.mX[247] = X_idx_77;
  out.mX[248] = X_idx_79;
  out.mX[249] = Cooling_system_Radiator_PS_Product_I1;
  out.mX[250] = X_idx_79 * 100.0;
  out.mX[251] = X_idx_22 * 1000.0;
  out.mX[252] = U_idx_0;
  out.mX[253] = X_idx_53;
  out.mX[254] = Cooling_system_Radiator_PS_Product_I1;
  out.mX[255] = X_idx_53;
  out.mX[256] = X_idx_54 * 0.1;
  out.mX[257] = 0.0;
  out.mX[258] = 0.0;
  out.mX[259] = -X_idx_54 / -1.0 * 99999.999999999985;
  out.mX[260] = X_idx_53;
  out.mX[261] = X_idx_79;
  out.mX[262] = X_idx_79 * 100.0;
  out.mX[263] = 0.0;
  out.mX[264] = X_idx_71;
  out.mX[265] = X_idx_72 * 0.1;
  out.mX[266] = X_idx_23;
  out.mX[267] = X_idx_23;
  out.mX[268] = X_idx_25;
  out.mX[269] = X_idx_25;
  out.mX[270] = 0.0;
  out.mX[271] = DC_DC_converter_averaged_Battery_sensors_Voltage_Sensor_V;
  out.mX[272] = 0.0;
  out.mX[273] = 0.0;
  out.mX[274] = X_idx_25;
  out.mX[275] = DC_DC_converter_averaged_Battery_sensors_Voltage_Sensor_V;
  out.mX[276] = 0.0;
  out.mX[277] = X_idx_23;
  out.mX[278] = X_idx_106;
  out.mX[279] = 0.0;
  out.mX[280] = 0.0;
  out.mX[281] = X_idx_25;
  out.mX[282] = t44;
  ...
  out.mX[285] = t44;
  out.mX[286] = 0.0;
  out.mX[287] = -X_idx_106;
  out.mX[288] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[289] = t44;
  out.mX[290] = X_idx_106 * -0.002;
  out.mX[291] = X_idx_16 * 0.16666666666666666;
  out.mX[292] = X_idx_16;
  out.mX[293] = Differential_pinion_crown_ratio_t_in;
  out.mX[294] = Differential_pinion_crown_ratio_t_in * -6.0;
  out.mX[295] = 0.0;
  out.mX[296] = 0.0;
  out.mX[297] = 0.0;
  out.mX[298] = X_idx_14;
  out.mX[299] = zc_int17;
  out.mX[300] = X_idx_109 * 1000.0;
  out.mX[301] = X_idx_109 * 1000.0;
  out.mX[302] = -(X_idx_14 - zc_int17) / -1.0;
  out.mX[303] = X_idx_14;
  out.mX[304] = 0.0;
  out.mX[305] = 0.0;
  out.mX[306] = X_idx_14;
  out.mX[307] = X_idx_14;
  out.mX[308] = X_idx_32;
  out.mX[309] = X_idx_33 * 0.1;
  out.mX[310] = X_idx_32;
  out.mX[311] = X_idx_33 * 0.1;
  out.mX[312] = X_idx_62;
  out.mX[313] = X_idx_60 * 1000.0;
  out.mX[314] = X_idx_60;
  out.mX[315] = X_idx_62;
  out.mX[316] = Energy_based_PMSM_drive_model_Heat_exchanger_PS_Product_I1;
  out.mX[317] = X_idx_114;
  out.mX[318] = X_idx_109 * 1000.0;
  out.mX[319] = X_idx_14;
  out.mX[320] = X_idx_86;
  out.mX[321] = Energy_based_PMSM_drive_model_Heat_exchanger_PS_Product_I1;
  out.mX[322] = X_idx_32;
  out.mX[323] = X_idx_33 * 0.1;
  out.mX[324] = X_idx_86;
  out.mX[325] = X_idx_87 * 0.1;
  out.mX[326] = zc_int17;
  out.mX[327] = X_idx_32;
  out.mX[328] = X_idx_33 * 0.1;
  out.mX[329] = X_idx_86;
  out.mX[330] = X_idx_87 * 0.1;
  out.mX[331] = zc_int17;
  out.mX[332] = X_idx_110;
  out.mX[333] = X_idx_112;
  out.mX[334] = -X_idx_60;
  out.mX[335] = -X_idx_88;
  out.mX[336] = X_idx_109;
  out.mX[337] = X_idx_13;
  out.mX[338] = X_idx_111;
  out.mX[339] = X_idx_113;
  out.mX[340] = -X_idx_62;
  out.mX[341] = 0.2;
  out.mX[342] = X_idx_15 * 0.1;
  out.mX[343] = (-X_idx_15 + X_idx_33) * 0.1;
  out.mX[344] = (-X_idx_15 + X_idx_87) * 0.1;
  out.mX[345] = X_idx_115;
  out.mX[346] = X_idx_116;
  out.mX[347] = X_idx_117;
  out.mX[348] = X_idx_118;
  out.mX[349] = X_idx_119;
  out.mX[350] = X_idx_120;
  out.mX[351] = X_idx_86;
  out.mX[352] = X_idx_87 * 0.1;
  out.mX[353] = 0.0;
  out.mX[354] = 0.0;
  out.mX[355] = -X_idx_87 / -1.0 * 99999.999999999985;
  out.mX[356] = X_idx_86;
  out.mX[357] = X_idx_62 * 100.0;
  out.mX[358] = X_idx_114;
  out.mX[359] = X_idx_62;
  out.mX[360] = X_idx_62 * 100.0;
  out.mX[361] = 0.0;
  out.mX[362] = 0.0;
  out.mX[363] = X_idx_16;
  out.mX[364] = X_idx_107 * 0.16666666666666666 + X_idx_108 *
    0.041666666666666664 + X_idx_121;
  out.mX[365] = X_idx_16 * 9.5492965855137211;
  out.mX[366] = 0.0;
  out.mX[367] = X_idx_14;
  out.mX[368] = X_idx_16;
  out.mX[369] = X_idx_16;
  out.mX[370] = U_idx_1;
  out.mX[371] = 0.0;
  out.mX[372] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[373] = 0.0;
  out.mX[374] = -X_idx_106;
  out.mX[375] = -X_idx_106;
  out.mX[376] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[377] = -DC_DC_converter_averaged_Resistor_n_v / -1.0;
  out.mX[378] = X_idx_14;
  out.mX[379] = -X_idx_106;
  out.mX[380] = 0.0;
  out.mX[381] = t46 * 1000.0;
  out.mX[382] = X_idx_16;
  out.mX[383] = X_idx_123;
  out.mX[384] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[385] = 0.0;
  out.mX[386] = X_idx_16;
  out.mX[387] = Energy_based_PMSM_drive_model_Servomotor_damper1_t;
  out.mX[388] = Energy_based_PMSM_drive_model_Servomotor_damper1_t *
    99999.999999999985;
  out.mX[389] = Energy_based_PMSM_drive_model_Servomotor_gain1_I;
  out.mX[390] = Energy_based_PMSM_drive_model_Servomotor_gain1_I * 50.0;
  out.mX[391] = 0.0;
  out.mX[392] = X_idx_14;
  out.mX[393] = t46 * 1000.0;
  out.mX[394] = t46 * 1000.0;
  out.mX[395] = -(-X_idx_14) / -1.0;
  out.mX[396] = Energy_based_PMSM_drive_model_Servomotor_gain1_I * 50.0;
  out.mX[397] = X_idx_17;
  out.mX[398] = X_idx_17;
  out.mX[399] = U_idx_1;
  out.mX[400] = X_idx_17;
  out.mX[401] = Energy_based_PMSM_drive_model_Servomotor_gain1_I;
  out.mX[402] = X_idx_14;
  out.mX[403] = 0.0;
  out.mX[404] = 0.0;
  out.mX[405] = X_idx_14;
  out.mX[406] = X_idx_14;
  out.mX[407] = X_idx_14;
  out.mX[408] = X_idx_122 * 1000.0;
  out.mX[409] = X_idx_14;
  out.mX[410] = 0.0;
  out.mX[411] = 0.0;
  out.mX[412] = 0.0;
  out.mX[413] = X_idx_16;
  out.mX[414] = X_idx_123;
  out.mX[415] = X_idx_123;
  out.mX[416] = -(-X_idx_16) / -1.0;
  out.mX[417] = 0.0;
  out.mX[418] = X_idx_16;
  out.mX[419] = X_idx_123;
  out.mX[420] = X_idx_17;
  out.mX[421] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[422] = 0.0;
  out.mX[423] = 0.0;
  out.mX[424] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[425] = DC_DC_converter_averaged_Resistor_n_v;
  out.mX[426] = X_idx_18;
  out.mX[427] = 0.0;
  out.mX[428] = X_idx_16;
  out.mX[429] = X_idx_16;
  ...
  out.mX[433] = X_idx_16;
  out.mX[434] = X_idx_16;
  out.mX[435] = X_idx_121;
  out.mX[436] = X_idx_121;
  out.mX[437] = 0.0;
  out.mX[438] = X_idx_124;
  out.mX[439] = X_idx_125;
  out.mX[440] = X_idx_126;
  out.mX[441] = X_idx_124;
  out.mX[442] = t48;
  out.mX[443] = U_idx_2;
  out.mX[444] = Longitudinal_vehicle_dynamics_Aerodynamic_drag_PS_Subtract_O;
  out.mX[445] = Longitudinal_vehicle_dynamics_Aerodynamic_drag_PS_Subtract_O;
  out.mX[446] = X_idx_126 * 1.3061224489795917;
  out.mX[447] = t48;
  out.mX[448] = X_idx_126 * 1.3061224489795917;
  out.mX[449] = X_idx_126;
  out.mX[450] = Longitudinal_vehicle_dynamics_Aerodynamic_drag_PS_Subtract_O *
    2.0;
  out.mX[451] = X_idx_127;
  out.mX[452] = 1.0;
  out.mX[453] = X_idx_127;
  out.mX[454] = X_idx_127 + 1.0;
  out.mX[455] = X_idx_127;
  out.mX[456] = 1.0;
  out.mX[457] = X_idx_127 + -1.0;
  out.mX[458] = X_idx_127 + -1.0;
  out.mX[459] = X_idx_127 + 1.0;
  out.mX[460] = X_idx_125;
  out.mX[461] = Longitudinal_vehicle_dynamics_Aerodynamic_drag_PS_Subtract_O;
  out.mX[462] = 1.0;
  out.mX[463] = Longitudinal_vehicle_dynamics_Aerodynamic_drag_PS_Subtract_O;
  out.mX[464] = Longitudinal_vehicle_dynamics_Aerodynamic_drag_PS_Subtract_O *
    2.0;
  out.mX[465] = X_idx_125;
  out.mX[466] = X_idx_19;
  out.mX[467] = 0.0;
  out.mX[468] = X_idx_16 * 0.16666666666666666;
  out.mX[469] = Longitudinal_vehicle_dynamics_Braking_torque_Ideal_Rotational_M;
  out.mX[470] = X_idx_19;
  out.mX[471] = 0.0;
  out.mX[472] = Longitudinal_vehicle_dynamics_Braking_torque_Ideal_Rotational_M;
  out.mX[473] = 0.0;
  out.mX[474] = X_idx_16 * 0.16666666666666666;
  out.mX[475] = X_idx_107;
  out.mX[476] = X_idx_107;
  out.mX[477] = -(-(X_idx_16 * 0.16666666666666666)) / -1.0;
  out.mX[478] = 0.0;
  out.mX[479] = U_idx_3;
  out.mX[480] = X_idx_128;
  out.mX[481] = X_idx_107;
  out.mX[482] = Longitudinal_vehicle_dynamics_Braking_torque_Ideal_Rotational_M *
    2.0;
  out.mX[483] = X_idx_129;
  out.mX[484] = 1.0;
  out.mX[485] = X_idx_129;
  out.mX[486] = X_idx_129 + 1.0;
  out.mX[487] = X_idx_129;
  out.mX[488] = 1.0;
  out.mX[489] = X_idx_129 + -1.0;
  out.mX[490] = X_idx_129 + -1.0;
  out.mX[491] = X_idx_129 + 1.0;
  out.mX[492] = X_idx_128;
  out.mX[493] = Longitudinal_vehicle_dynamics_Braking_torque_Ideal_Rotational_M;
  out.mX[494] = 1.0;
  out.mX[495] = Longitudinal_vehicle_dynamics_Braking_torque_Ideal_Rotational_M;
  out.mX[496] = Longitudinal_vehicle_dynamics_Braking_torque_Ideal_Rotational_M *
    2.0;
  out.mX[497] = X_idx_128;
  out.mX[498] = 0.0;
  out.mX[499] = X_idx_16 * 0.041666666666666664;
  out.mX[500] = Longitudinal_vehicle_dynamics_Ideal_Force_Source_S;
  out.mX[501] = Longitudinal_vehicle_dynamics_Ideal_Force_Source_S;
  out.mX[502] = -(-(X_idx_16 * 0.041666666666666664)) / -1.0;
  out.mX[503] = 0.0;
  out.mX[504] = X_idx_20;
  out.mX[505] = X_idx_16 * 0.041666666666666664;
  out.mX[506] = t48;
  out.mX[507] = 0.0;
  out.mX[508] = t48;
  out.mX[509] = X_idx_20;
  ...
  out.mX[512] = 0.0;
  out.mX[513] = U_idx_4;
  out.mX[514] = X_idx_124;
  out.mX[515] = Longitudinal_vehicle_dynamics_Ideal_Force_Source_S;
  out.mX[516] = X_idx_16 * 0.041666666666666664;
  out.mX[517] = -X_idx_124 + -X_idx_108 + U_idx_4;
  out.mX[518] = X_idx_21;
  out.mX[519] = X_idx_16 * 0.16666666666666666;
  out.mX[520] = X_idx_16 * 0.041666666666666664;
  out.mX[521] = X_idx_108;
  out.mX[522] = X_idx_108 * -0.25;
  out.mX[523] = 0.0;
  (void)t0;
  (void)t88;
  return 0;
