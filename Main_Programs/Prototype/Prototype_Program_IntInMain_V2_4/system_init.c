...
void system_init() {
    ...
    /******** IO *********/
    DDRF |= (0<<PF6) | (0<<PF5);  //Accelerate, and pirate switch (input) buttons on PORTD 6, 7, 0. Set PC_ON_OFF (output) PORTD 5.
    PORTF |= (1<<PF6) | (1<<PF5); //Set pullup resistors for input pins and turn on PC_ON_OFF pin
